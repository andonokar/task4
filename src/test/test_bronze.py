...
class BronzeTest(unittest.TestCase):
    ...
    def test_ingest_data(self):
        encoded_text = "OTY2ODY1NjAxMwlJbXByZXNzaW9uCURvbGxhciBUcmVlCTMgOQlGZW1hbGUJMTAwaysJLzIwMTYvMDUvZGl5LWZyaWRhLWthaGxvLWhlYWQtdmFzZS5odG1sLwlGbG9yaWRhCVVT"
